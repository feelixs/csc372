...
$(document).ready(function () {
    ...
    */
    ...
    galDualImages.push(new DualLangImage(`${domain}/static/images/buttons/globe-white-en.webp`,
        `${domain}/static/images/buttons/globe-white-es.webp`, $('#change-language-img')))
    ...
    loadGallery(`${domain}/static/data/json/gallery.json`);
})
